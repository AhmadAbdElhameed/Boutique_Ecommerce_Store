                    ...
                    <table class="table text-nowrap">
                        ...
                        <tr>
                            <th class="ps-0 py-3 border-light" scope="row">
                                <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="{{route('details')}}"><img src="{{asset('assetsFront/img/product-detail-3.jpg')}}" alt="..." width="70"/></a>
                                    <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="{{route('details')}}">Red digital smartwatch</a></strong></div>
                                </div>
                            </th>
                        ...
                        <tr>
                            <th class="ps-0 py-3 border-0" scope="row">
                                <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="{{asset('assetsFront/img/product-detail-2.jpg')}}" alt="..." width="70"/></a>
